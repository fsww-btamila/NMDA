var config = {
    ...
    "procedureServices": {
        ...
        "calcWeightVolumeQty": "MN_CalWeightVolumeQty",
        ...
        "offlineTankChart": "MN_GetTankChartDetails",
        "getDocLogo": "MN_GetDocLogo",
        "getOrderStatus":"MN_GetOrderStatus",
        "some": "newservice"
    },
    "tableServices": {},
   ...
   "nodeURL": "http://206.222.191.229:2994/",
   // "nodeURL": "https://tamilfsww-eval-test.apigee.net/meterpdf/",
   // "nodeURL": "https://7667de1aaed0.ngrok.io/",
   // "nodeURL": "http://testdeliverystream.firestreamonline.com:8100/",
    ...
    "offlineAttachPath" : 'https://fswwmarine.blob.core.windows.net/order-data/',
    "dump":"sql", //json OR sql
    "doiData": [{
            "ID": "47",
    ...
    "CompanyName":[{
            "ID": "01",
            "name": "JOHN W. STONE OIL DISTRIBUTOR, L.L.C." 
        },
        {
            "ID": "02",
            "name": "ECONOMY / STONE MIDSTREAM FUEL, L.L.C." 
        }],
    "LoadingOffline": true,
    "version": "3.33",
    "source": "ordersNew"
