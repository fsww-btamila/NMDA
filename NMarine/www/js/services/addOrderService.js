app.service('addOrderService', function($q, $rootScope, $http, appConstants, getAllSiteService, readingService, weightVolumeService, $cordovaSQLite) {
  ...
  function parameterize(p_array) {
    let reqData = "CustomerID="+customerId+"&INSiteTankID="+p_array.join();
    // return '(' + customerId + ',' + p_array.join() + ')' + '?';
    return reqData;
  }
  this.getProducts = function(lazyLoadParams, activeStatus, callback) {
    var reqData = "CompanyID="+$rootScope.CompanyID + "&";
    var searchTxt = lazyLoadParams.SearchText;
    var startIndex = lazyLoadParams.MinRecord;
    var endIndex = lazyLoadParams.MaxRecord;
    if (searchTxt) {
      reqData += "CustomerID="+customerId+"&MasterSiteID="+$rootScope.MasterSiteID+"&SearchText="+searchTxt;
    } else if (startIndex && endIndex) {
      reqData += "CustomerID="+customerId+"&MasterSiteID="+$rootScope.MasterSiteID+"&MinRecord="+startIndex+"&MaxRecord="+endIndex;
    } else {
      reqData += "CustomerID="+customerId+"&MasterSiteID="+$rootScope.MasterSiteID;
    }
    ...
    if ($rootScope.isInternet && $rootScope.online && !loadingOffline) {
      var url = appConstants.baseUrl + appConstants.procedureServices.getProducts + "?"+ reqData;
      $http.get(url)
  ...
  this.getVessels = function(searchVesselParams, callback) {
    ...
    if (searchTxt) {
      reqData += "CustomerID="+customerId+"&SearchText="+searchTxt;
    } else if (startIndex && endIndex) {
      reqData += "CustomerID="+customerId+"&MinRecord="+startIndex+"&MaxRecord="+ endIndex;
    } else {
      reqData += "CustomerID="+customerId;
    }

    if ($rootScope.isInternet && $rootScope.online && !loadingOffline) {
      var url = appConstants.baseUrl + appConstants.procedureServices.getVessels + "?" + reqData;
      $http.get(url)
        .success(function(data) {
          callback(data);
        }).error(function(err) {
  ...
  this.getDrivers = function(callback) {
    ...
    var url = appConstants.baseUrl + appConstants.procedureServices.getDrivers + "?" +reqData;
  ...
  this.getVehicles = function(callback) {
    if ($rootScope.isInternet && $rootScope.online) {
      let reqData = "CompanyID="+$rootScope.CompanyID+"&CustomerID="+customerId;
      var url = appConstants.baseUrl + appConstants.procedureServices.getVehicles + "?"+ reqData;
      $http.get(url)
        .success(function(data) {
          callback(data);
        }).error(function(err) {
  ...
  this.getAvailability = function(details) {
    ...
    return $http.post(appConstants.baseUrl + appConstants.procedureServices.getAvailability, JSON.stringify(parameter));
  };
  ...
  this.saveOrder = function(reqData, orderNo) {
    ...
    return $http.post(appConstants.baseUrl + appConstants.procedureServices.saveOrder  , parameter)
      .success(function(data) {
        return data;
  ...
  this.getTanks = function(callback) {
    let reqData = "CustomerID="+customerId;
    var url = appConstants.baseUrl + appConstants.procedureServices.getTanks + "?" + reqData;
    $http.get(url, { cache: true })
      .success(function(data) {
        void 0;
        callback(data);
  ...
  this.getSourceTanks = function(insiteID, ProdContID, dt, callback) {
    ...
    if (dt) {
      ...
      reqData="CompanyID="+$rootScope.CompanyID+"&CustomerID="+customerId+"&INSiteID="+insiteID+"&ProdContID="+ProdContID+"&IsBillingItem='N' & OrderDate="+dt;
    } else {
      // var parameterString = parameterizeWithComp([insiteID, ProdContID]);
      reqData="CompanyID="+$rootScope.CompanyID+"&CustomerID="+customerId+"&INSiteID="+insiteID+"&ProdContID="+ProdContID
    }
    if ($rootScope.isInternet && $rootScope.online && !loadingOffline) {
      var url = appConstants.baseUrl + appConstants.procedureServices.getSourceTanks , parameterString;
  ...
  this.getTankSubCompartments = function(INSiteTankID, callback) {
    ...
    let reqData = "CustomerID="+customerId+"&INSiteTankID="+INSiteTankID;
    if ($rootScope.isInternet && $rootScope.online && !loadingOffline) {
      var url = appConstants.baseUrl + appConstants.procedureServices.getTankSubCompartments +"?"+ reqData;
      return $http.get(url, { cache: false })
    } else {
      var deferred = $q.defer();
  ...
  this.getVehicleCompartments = function(vehicleID, callback) {
    ...
    if ($rootScope.isInternet && $rootScope.online) {
      let reqData = "CustomerID="+customerId+"&vehicleID="+vehicleID;
      var url = appConstants.baseUrl + appConstants.procedureServices.getVehicleCompartments +"?"+ reqData;
      return $http.get(url, { cache: false })
    } else {
      var deferred = $q.defer();
  ...
  this.getVehicleSubCompartments = function(vehicleID, compartmentID, callback) {
    ...
    if ($rootScope.isInternet && $rootScope.online) {
      let reqData = "CustomerID="+customerId+"&vehicleID="+vehicleID+"&compartmentID="+compartmentID;
      var url = appConstants.baseUrl + appConstants.procedureServices.getVehicleSubCompartments +"?"+ reqData;
      return $http.get(url, { cache: false })
    } else {
      var deferred = $q.defer();
  ...
  this.calcShipReading = function(reqData, callback) {
    if ($rootScope.isInternet && $rootScope.online) {
      ...
      $http.post(appConstants.baseUrl + appConstants.procedureServices.calcShipReading  , parameter, { timeout: 4000 })
        .success(function(data) {
          callback(data)
        }).error(function(err) {
          // return err;
      ...
      $http.post(appConstants.baseUrl + appConstants.procedureServices.calcShipReading , parameter);
    }
  }
  this.calcTankReading = function(reqData, callback) {
    ...
    if ($rootScope.isInternet && $rootScope.online) {
      $http.post(appConstants.baseUrl + appConstants.procedureServices.updateTankVolume , parameter, { timeout: 4000 })
        .success(function(data) {
          callback(data)
        }).error(function(err) {
          // return err;
      ...
      $http.post(appConstants.baseUrl + appConstants.procedureServices.updateTankVolume  , parameter);
      readingService.calculateReading(reqData, 1, function(res) {
        callback(res)
      });
    }
  ...
  this.getAllDoiQus = function(doicCode) {
    var doiTypeString = 'S';
    var url = appConstants.baseUrl + appConstants.procedureServices.getAllDoiQus + "(" + customerId + "," + doiTypeString + ")?" + appConstants.dreamFactoryApiKeySet;
  ...
  this.postDoi = function(reqData) {
    ...
    return $http.post(appConstants.baseUrl + appConstants.procedureServices.postDOI , parameter)
      .success(function(data) {
        return data;
      }).error(function(err) {
        void 0;
  ...
  this.postDeliveryTicket = function(reqData) {
    ...
    return $http.post(appConstants.baseUrl + appConstants.procedureServices.postDeliveryTicket  , parameter)
      .success(function(data) {
        return data;
      }).error(function(err) {
        void 0;
  ...
  this.uploadDeliveryTicket = function(reqData) {
    ...
    return $http.post(appConstants.filepath , parameter)
      .success(function(data) {
        return data;
      }).error(function(err) {
        void 0;
  ...
  this.postShipment = function(reqData, orderNo) {
    ...
    return $http.post(appConstants.baseUrl + appConstants.procedureServices.postShipment , parameter, { timeout: 10000 })
      .success(function(data) {
        return data;
      }).error(function(err) {
        console.log(err);
  ...
  this.postDelivery = function(reqData, orderNo) {
    ...
    return $http.post(appConstants.baseUrl + appConstants.procedureServices.postDelivery  , parameter, { timeout: 10000 })
      .success(function(data) {

        if (!(data[0] && data[0].StatusNew == 'Success')) {

          $http.post(appConstants.baseUrl + appConstants.procedureServices.postDelivery , parameter, { timeout: 10000 })
        }
        return data;
      }).error(function(err) {
        return err;
  ...
  this.postMeterTicket = function(reqData) {
    ...
    return $http.post(appConstants.baseUrl + appConstants.procedureServices.postMeterTicket  , parameter)
      .success(function(data) {
        return data;
      }).error(function(err) {
        return err;
  ...
  this.getShortcuts = function(callback) {
    if ($rootScope.isInternet && $rootScope.online && !loadingOffline) {
      let reqData = "CompanyID=" + $rootScope.CompanyID + "&CustomerID=" + customerId + "&MasterSiteID=" + $rootScope.MasterSiteID;
      var url = appConstants.baseUrl + appConstants.procedureServices.getShortcuts + "?"+ reqData;
      $http.get(url, { cache: true })
        .success(function(data) {
          callback(data);
        }).error(function(err) {
  ...
  this.getDocMessages = function(callback) {
    ...
    let reqData = "CustomerID="+customerId+"&CompanyID="+$rootScope.CompanyID;
    var url = appConstants.baseUrl + appConstants.procedureServices.getDocMessages + "?" + reqData;
    $http.get(url, { cache: true })
      .success(function(data) {
        callback(data);
      }).error(function(err) {
  ...
  this.getAttachments = function(customerId, orderNo) {
    var url = appConstants.baseUrl + appConstants.procedureServices.getAttachments + '(' + customerId + ',' + orderNo + ')' + "?" + appConstants.dreamFactoryApiKeySet;
    return $http.get(url, { cache: true })
      .success(function(data) {
        return data;
      }).error(function(err) {
  ...
  this.deleteAttachment = function(attachmentId, orderNo) {
    let reqData = "attachmentId="+attachmentId + '&orderNo=' + orderNo;
    var url = appConstants.baseUrl + appConstants.procedureServices.deleteAttachment  + "?" + reqData;
    return $http.get(url, { cache: true })
      .success(function(data) {
        return data;
      }).error(function(err) {
  ...
  this.postAttachment = function(reqData) {
    ...
    return $http.post(appConstants.baseUrl + appConstants.procedureServices.postAttachment  , parameter)
      .success(function(data) {
        return data;
      }).error(function(err) {
        return err;
  ...
  this.getActivityLog = function(customerId, orderNo) {
    let reqData = "CompanyID=" + $rootScope.CompanyID + "&CustomerID=" + customerId + '&OrderNo=' + orderNo;
    var url = appConstants.baseUrl + appConstants.procedureServices.getActivityLog +"?" + reqData;
    return $http.get(url, { cache: false })
      .success(function(data) {
        return data;
      }).error(function(err) {
  ...
  this.updateOrderStatus = function(reqData, orderNo) {
    ...
    return $http.post(appConstants.baseUrl + appConstants.procedureServices.updateOrderStatus  , parameter)
      .success(function(data) {
        return data;
      }).error(function(err) {
        return err;
  ...
  /*this.calcWeightVolumeQty = function(reqData, callback) {
    ...
    $http.post(appConstants.baseUrl + appConstants.procedureServices.calcWeightVolumeQty , parameterString + appConstants.dreamFactoryApiKeySet)
      .success(function(data) {
        callback(data)
      }).error(function(err) {
        return err;
  ...
  this.calcWeightVolumeQty = function(reqData, callback) {
    ...
    if ($rootScope.isInternet && $rootScope.online) {
      $http.post(appConstants.baseUrl + appConstants.procedureServices.calcWeightVolumeQty  , parameter, { timeout: 4000 })
        .success(function(data) {
          callback(data);
        }).error(function(err) {
          return err;
      ...
      $http.post(appConstants.baseUrl + appConstants.procedureServices.calcWeightVolumeQty , parameter);
  ...
  this.deleteOrder = function(orderNo, callback) {
    ...
    var url = appConstants.baseUrl + appConstants.procedureServices.deleteOrder, parameterString ;
    return $http.get(url, { cache: true })
  };
  ...
  this.postAdHocVessel = function(vesselCode, grossTonnage, imo, additionalNotes) {
    ...
    return $http.post(appConstants.baseUrl + appConstants.procedureServices.postAdHocVessel , parameter)
      .success(function(data) {
        return data;
      }).error(function(err) {
        return err;
  ...
  this.logoutUser = function() {
    ...
    if ($rootScope.isInternet && $rootScope.online) {
      return $http.post(appConstants.baseUrl + appConstants.procedureServices.logout, parameter)
        .success(function(data) {
          return data;
        }).error(function(err) {
          return err;
  ...
  this.ClearUserSession = function() {
    ...
    return $http.post(appConstants.baseUrl + appConstants.procedureServices.ClearUserSession, parameter)
      .success(function(data) {
        return data;
      }).error(function(err) {
        return err;
  ...
  this.CancellOrder = function(SysTrxNo, OrderStatus, UserID) {
    ...
    return $http.post(appConstants.baseUrl + appConstants.procedureServices.updateCancelOrders , parameter)
      .success(function(data) {
        return data;
      }).error(function(err) {
        return err;
  ...
  this.getDocLogo = function() {
    var url = appConstants.baseUrl + appConstants.procedureServices.getDocLogo;
    return $http.get(url);
  };
  ...
  this.getOrderStatus = function(param) {
    return $http.post(appConstants.baseUrl + appConstants.procedureServices.getOrderStatus, param)
      .success(function(data) {
        return data;
      }).error(function(err) {
        return err;
